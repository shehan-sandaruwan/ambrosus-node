...
describe('Challenges repository', () => {
  ...
  describe('filterOutFinishedChallenges', () => {
    ...
    const allChallenges = [
      ...
      // {challengeId: '4', count: 3},
      // {challengeId: '5', count: 3}
    ...
    const resolvedChallenges = [
      ...
      // {challengeId: '100', resolverId: otherAddress},
      // {challengeId: '6', resolverId: otherAddress}
    ];
    ...
    it('should remove challenges that where fully resolved (resolutions count match start count)', async () => {
    ...
    it('should remove challenges that where resolved by the current atlas', async () => {
